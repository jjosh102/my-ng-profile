...
export class GetLanguageColorPipe implements PipeTransform {
  private readonly defaultColor = '#cccccc';
  private readonly storageKey = 'language-colors';
  ...
  constructor() {
    ...
    if (cached) {
      this.languageColors = JSON.parse(cached);
    } else {
      this.languageColors = {
        "css": "#563d7c",
        "html": "#e34c26",
      ...
      localStorage.setItem(this.storageKey, JSON.stringify(this.languageColors));
    }
  }
